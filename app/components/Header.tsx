...
export default function Header({ userName, userRole, onMenuClick, isCollapsed }: HeaderProps) {
    ...
    return (
        <header className="bg-white border-b border-gray-100 sticky top-0 z-30 transition-all duration-300">
            <div className="px-4 lg:px-8 py-4 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <Link
                            href="/"
                            className="flex items-center gap-2 px-3 py-2 lg:px-4 lg:py-2 rounded-xl text-indigo-600 hover:bg-indigo-50 hover:text-indigo-700 transition-all border border-transparent hover:border-indigo-100"
                        >
                            <Icon icon="solar:home-smile-bold-duotone" width="20" height="20" />
                            <span className="font-medium hidden md:block">หน้าหลัก</span>
                        </Link>
